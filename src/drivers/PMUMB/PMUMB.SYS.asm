...
; far jump (EAh XXXX:XXXX) to a program which has hooked itself into the XMS driver chain
...
.Search:
		...
		jz		SHORT .Search			; If size=0, get next block
...
; Code above this does not remain resident
...
s$Hello1		db	0Dh,0Ah,'PMUMB : UMB Manager for PicoMEM (Modified USE!UMBS by Marco van Zwetselaar)',0Dh,0Ah
s$Empty			db	'',0Dh,0Ah,'$'
s$XMMfound     db  ' > XMS Memory Manager Found',0Dh,0Ah,0Ah,'$'
s$PMFound       db  ' > PicoMEM Found $'
s$PMNotFound    db  ' > Error: PicoMEM Not Found',0Dh,0Ah,0Ah,'$'
s$Installed		db	' > Installed!',0Dh,0Ah,0Ah,'$'
s$NotInstalled	db	' > Not Installed!  UMBs Managed Already!',0Dh,0Ah,0Ah,'$'
