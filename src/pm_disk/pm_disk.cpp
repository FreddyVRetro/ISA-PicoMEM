...
// Set the disk Geometry, May need to be improved
		 imageDiskList[hddnumber+1]->Set_Geometry(16, (uint32_t)(finfo.fsize / (512 * 63 * 16)), 63, 512); // H C S
...
uint8_t NewHDDImage()
{
  ...
  SizeName_t *NewHDD=(SizeName_t *)&PCCR_Param;
  FRESULT fr; /* Return value */
  FIL img;
